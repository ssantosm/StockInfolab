...
class ComboBoxClasificacionTres extends Component {
...
componentDidMount() {
  ...
  const ClasificacionFilters = {
    ClasificacionId : 0,
    ClasificacionNombre: "",
    ClasificacionOrden: 3 //Se introduce el tipo de clasificación que se requiera ver
  }
...
renderPosts = () => {
    ...
    const {FProductoClasificacionTres} = this.props
    
    return posts.map(post => {
      const { ClasificacionNombre, ClasificacionOrden, ClasificacionId } = post;
 
      if(ClasificacionId == FProductoClasificacionTres)
      {
        return (
...
render() {
    ...
    return (
      ...
      <InputLabel htmlFor="outlined-age-native-simple" >Clasificación 3</InputLabel>
                 <Select
                 id="ClasificacionTres"
                 native
    ...
    //          <InputLabel htmlFor="outlined-age-native-simple">Clasificacion 3</InputLabel>
    //                     <Select
    //                     native
    //                    // value={state.Tipo}
    //                     onChange={getClasificacionValue}
...
export default ComboBoxClasificacionTres;